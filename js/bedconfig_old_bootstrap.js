...
const allItemInfoSpans = document.querySelectorAll('.bedconfig-item-info-span');
...
function showNextSite () {
    ...
    allSites[currentSite].style.display = "flex";
}
...
function createCart (calculatedMattress, calculatedTopper, calculatedPillowOptions, calculatedBlanket) {
    ...
    if (calculatedTopper.name === "Kein Topper") {
        ...
        allItemInfoSpans[3].innerHTML = calculatedTopper.name;
        allItemInfoSpans[4].innerHTML = calculatedTopper.width + "x" + calculatedTopper.length + "cm";
        allItemInfoSpans[5].innerHTML = "weich";
        recommendedTopperItem.childNodes.item(7).innerHTML = calculatedTopper.price + "€";
    }

    allItemInfoSpans[0].innerHTML = calculatedMattress.name;
    allItemInfoSpans[1] = calculatedMattress.width + "x" + calculatedMattress.length + "cm";
    allItemInfoSpans[2].innerHTML = recommendedMattressSide;
    recommendedMattressItem.childNodes.item(7).innerHTML = calculatedMattress.price + "€";
    
    allItemInfoSpans[9].innerHTML = calculatedBlanket.name;
    allItemInfoSpans[10].innerHTML = calculatedBlanket.width + "x" + calculatedBlanket.length + "cm";
    allItemInfoSpans[11].innerHTML = calculatedBlanket.material;
    recommendedBlanketItem.childNodes.item(7).innerHTML = calculatedBlanket.price + "€";

    allItemInfoSpans[6].innerHTML = calculatedPillowOptions[0].name;
    allItemInfoSpans[7].innerHTML = calculatedPillowOptions[0].width + "x" + calculatedPillowOptions[0].length + "cm";
    allItemInfoSpans[8].innerHTML = calculatedPillowOptions[0].material;
